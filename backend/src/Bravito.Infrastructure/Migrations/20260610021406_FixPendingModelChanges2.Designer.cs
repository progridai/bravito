...
namespace Bravito.Infrastructure.Migrations
{
    ...
    [Migration("20260610021406_FixPendingModelChanges2")]
            ...
            modelBuilder.Entity("Bravito.Domain.Acesso.PerfilAcesso", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Ativo = true,
                            DataCriacao = new DateTime(2026, 6, 10, 2, 14, 5, 691, DateTimeKind.Utc).AddTicks(1447),
                        ...
                        new
                        {
                            ...
                            Ativo = true,
                            DataCriacao = new DateTime(2026, 6, 10, 2, 14, 5, 691, DateTimeKind.Utc).AddTicks(2067),
                        ...
                        new
                        {
                            ...
                            Ativo = true,
                            DataCriacao = new DateTime(2026, 6, 10, 2, 14, 5, 691, DateTimeKind.Utc).AddTicks(2073),
            ...
            modelBuilder.Entity("Bravito.Domain.Acesso.PerfilAcessoRecurso", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("d2704adf-88f5-496c-9b1e-9c4d3dcda463"),
                            DataCriacao = new DateTime(2026, 6, 10, 2, 14, 5, 692, DateTimeKind.Utc).AddTicks(8941),
                            PerfilAcessoId = new Guid("11111111-1111-1111-1111-111111111111"),
                            RecursoId = new Guid("a0000000-0000-0000-0000-000000000001")
                        },
                        new
                        {
                            Id = new Guid("493fc9d8-0787-4047-9b0f-9794058f7a31"),
                            DataCriacao = new DateTime(2026, 6, 10, 2, 14, 5, 692, DateTimeKind.Utc).AddTicks(9323),
                            PerfilAcessoId = new Guid("11111111-1111-1111-1111-111111111111"),
                            RecursoId = new Guid("a0000000-0000-0000-0000-000000000002")
                        },
                        new
                        {
                            Id = new Guid("c73b0af7-76ac-4e22-a462-573c7ee8512d"),
                            DataCriacao = new DateTime(2026, 6, 10, 2, 14, 5, 692, DateTimeKind.Utc).AddTicks(9326),
                            PerfilAcessoId = new Guid("11111111-1111-1111-1111-111111111111"),
                            RecursoId = new Guid("a0000000-0000-0000-0000-000000000003")
                        },
                        new
                        {
                            Id = new Guid("e817a276-964a-49d3-95e9-3b53a73b7299"),
                            DataCriacao = new DateTime(2026, 6, 10, 2, 14, 5, 692, DateTimeKind.Utc).AddTicks(9336),
                            PerfilAcessoId = new Guid("11111111-1111-1111-1111-111111111111"),
                            RecursoId = new Guid("a0000000-0000-0000-0000-000000000004")
                        },
                        new
                        {
                            Id = new Guid("f0a781ce-4290-425e-8c60-2f3c68d0173a"),
                            DataCriacao = new DateTime(2026, 6, 10, 2, 14, 5, 692, DateTimeKind.Utc).AddTicks(9338),
                            PerfilAcessoId = new Guid("11111111-1111-1111-1111-111111111111"),
                            RecursoId = new Guid("a0000000-0000-0000-0000-000000000005")
                        },
                        new
                        {
                            Id = new Guid("41ffaebc-094b-48e2-8cfc-3cc3df4199de"),
                            DataCriacao = new DateTime(2026, 6, 10, 2, 14, 5, 692, DateTimeKind.Utc).AddTicks(9344),
                            PerfilAcessoId = new Guid("11111111-1111-1111-1111-111111111111"),
                            RecursoId = new Guid("a0000000-0000-0000-0000-000000000006")
                        },
                        new
                        {
                            Id = new Guid("1ccc16be-e08f-4e95-830d-c9cd038f7521"),
                            DataCriacao = new DateTime(2026, 6, 10, 2, 14, 5, 692, DateTimeKind.Utc).AddTicks(9352),
                            PerfilAcessoId = new Guid("22222222-2222-2222-2222-222222222222"),
                            RecursoId = new Guid("a0000000-0000-0000-0000-000000000001")
                        },
                        new
                        {
                            Id = new Guid("425ca36a-c9ef-42a2-8c65-4de0daef02e4"),
                            DataCriacao = new DateTime(2026, 6, 10, 2, 14, 5, 692, DateTimeKind.Utc).AddTicks(9358),
                            PerfilAcessoId = new Guid("22222222-2222-2222-2222-222222222222"),
                            RecursoId = new Guid("a0000000-0000-0000-0000-000000000002")
                        },
                        new
                        {
                            Id = new Guid("9dc5fa23-d249-4c00-b28a-231acae0ce37"),
                            DataCriacao = new DateTime(2026, 6, 10, 2, 14, 5, 692, DateTimeKind.Utc).AddTicks(9361),
            ...
            modelBuilder.Entity("Bravito.Domain.Acesso.Recurso", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Ativo = true,
                            Codigo = "chat.acessar",
                            DataCriacao = new DateTime(2026, 6, 10, 2, 14, 5, 692, DateTimeKind.Utc).AddTicks(5299),
                        ...
                        new
                        {
                            ...
                            DataCriacao = new DateTime(2026, 6, 10, 2, 14, 5, 692, DateTimeKind.Utc).AddTicks(5742),
                        ...
                        new
                        {
                            ...
                            DataCriacao = new DateTime(2026, 6, 10, 2, 14, 5, 692, DateTimeKind.Utc).AddTicks(5747),
                        ...
                        new
                        {
                            ...
                            DataCriacao = new DateTime(2026, 6, 10, 2, 14, 5, 692, DateTimeKind.Utc).AddTicks(5752),
                        ...
                        new
                        {
                            ...
                            DataCriacao = new DateTime(2026, 6, 10, 2, 14, 5, 692, DateTimeKind.Utc).AddTicks(5756),
                        ...
                        new
                        {
                            ...
                            DataCriacao = new DateTime(2026, 6, 10, 2, 14, 5, 692, DateTimeKind.Utc).AddTicks(5791),
